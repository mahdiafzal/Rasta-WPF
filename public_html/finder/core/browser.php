...
class browser extends uploader {
    ...
    public function __construct() {
		...
		chmod($thumbsDir, $this->config['dirPerms']);
    ...
    protected function act_upload() {
		...
		// this codes add by Rastak CMS and replaced by commented code after that
        if ( !isset($this->post['dir']) ) $this->errorMsg("Unknown error.");
        if ( !$this->config['access']['files']['upload'] ) $this->errorMsg("Cannot access or write to upload folder.");
