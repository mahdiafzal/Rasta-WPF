...
Ctoolbar.fn=Ctoolbar.prototype=
{
	...
	savePage:function()
		{		
			...
			$_.ajax({
				...
				type		: 'post',
				dataType	: 'json',
				data:{'content':SectionCloneHTML ,'pageID': config.site.pageId , 'slogan':slogan ,'authors':authors ,'description':description ,'keywords':keywords ,'skin':skin, 'menuskin':menuskin, 'pagedir':pagedir},
	...
	prevPage:function()
		{
			opendwindow	=	window.open('/page/'+config.site.pageId);
		},
	rtcManager:function()
		{
			Crtc.fn.rtcPopupAction=false;
			popupwin= window.open(config.baseURL.rtcm+'/frmlistcnt/index/env/dsh#fragment-2','RTCMANAGER');
			return this;
		},
	fileManager:function()
		{
			...
			else
			{
				...
				fileManagerWin	=	window.open(
											'/finder/browse.php?type=files&action=manager&lang='+config.site.lang,
											'FileManager',
