			...
			else
			{
				...
				foreach($sec->children() as $itm)
				{
					...
					if($type=='s')
					{
						...
						$senarioPart .= "\n\t\t<item:data.fields>".$attrs['r-fields']."</item:data.fields>";
						$senarioPart .= "\n\t\t<item:data.count>".$attrs['r-count']."</item:data.count>";
						$senarioPart .= "\n\t\t<item:skin.block>metablock</item:skin.block>";
					}
					$pageXAL_c .= "\n<item>\n\t<tree>\n\t\t<item:ns></item:ns>\n\t\t<item:type>".$type."</item:type>\n\t\t<item:id>".$unic."</item:id>\n\t\t<item:container>".$section_id."</item:container>\n\t\t<item:rank>".$rank."</item:rank>".$senarioPart."\n\t</tree>\n</item>";
					$rank ++;
