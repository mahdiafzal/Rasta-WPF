...
class Scenario_AdminController extends Zend_Controller_Action 
{
    ...
    public function crtAction() 
    {
		...
		$data['xal']		= addslashes($this->params['s_xal']);
		...
		if(count($msg)>0)
		{
			...
			$this->_redirect('/scenario/admin/frmcrt#fragment-2');
		}
		...
		$msg[] = $translate->_('g');
		$this->_helper->FlashMessenger($msg);
		$this->_redirect('/scenario/admin/frmlist#fragment-2');
    }	
    ...
    public function editAction() 
    {
		...
		if(count($msg)>0)
		{
			...
			$data['id']= $id;
			$this->_helper->FlashMessenger($data);
			$this->_redirect('/scenario/admin/frmedit/id/'.$id.'#fragment-2');
		}
