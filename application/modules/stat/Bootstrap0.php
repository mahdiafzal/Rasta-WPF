...
{
	protected function _initStat()
    {
    	//$StatProtocol		= Zend_Controller_Action_HelperBroker::addHelper(new Stat_Model_Helper_Register());
//		return true;
//		$front = Zend_Controller_Front::getInstance();
//		$front->registerPlugin(new Stat_Model_Plugin_Register() );
...
//				.	$data['referer'].'", "'.$data['uri'].'", @cou);';
		...
		try
		{
			...
			$result	= $this->DB->insert('log_visitor', $data);
