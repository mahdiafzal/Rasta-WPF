<?php
class Godpanel_PublicController extends Zend_Controller_Action
{
	...
	public function ajaxvalidatorAction()
	{
		...
		{
			echo '<h5>دامنه وارد شده معتبر می باشد</h5>';
		}
		else
		{
			//print_r($result);
			foreach($result as $itm)
			{
				switch ($itm)
				{
					case -1:	echo '<h5>دامنه وارد شده جز موارد ممنوعه و در لیست سیاه می باشد. در صورت اشتباه مراتب را با مدیریت در میان بگذارید</h5>'; break;
					case -2:	echo '<h5>دامنه وارد شده قبلا برای پورتال دیگری پارک شده است</h5>'; break;
					case -3:	echo '<h5>طول دامنه باید بیشتر از 3 و کمتر از 51 باشد</h5>'; break;
					case -4:	echo '<h5>زیر دامنه وارد شده باید با حروف یا اعداد شروع شود و نیز فقط شامل خط تیره می باشد(خط تیره نمی تواند کاراکتر پایانی باشد)</h5>'; break;
					case -5:	echo '<h5>پسوند دامنه وارد شده معتبر نمی باشد</h5>'; break;
				}
			}
		}
