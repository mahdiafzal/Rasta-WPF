...
class Rcpanel_Model_User_User
{
	...
	static function authenticate($username, $password, $allState=false)
	{
		return self::_authenticate($username, $password, $allState);
	}
	...
	public function _authenticate($username, $password, $allState=false)
	{
	...
	public function _sendEmail($username,$data)
	{
		...
		try 
		{
			...
			$link			= "http://".$config->base->portal."/rcpanel/user/activation/".$data_temp['userid'].".".$data_temp['code'];		
