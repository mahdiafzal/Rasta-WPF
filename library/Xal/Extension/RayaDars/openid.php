...
class LightOpenID
{
    ...
    protected function getAxAttributes()
    {
        ...
        foreach ($this->data as $key => $value) {
            ...
            if (!isset($this->data['openid_' . $alias . '_value_' . $key."_1"])) {
            ...
            $attributes[$this->data['openid_' . $alias . '_type_' . $atKey]] = $this->data['openid_' . $alias . '_value_' . $atKey."_1"];
        }
        return $attributes;
    }
