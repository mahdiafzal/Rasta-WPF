...
class Rasta_Finder_Init
{
	...
	public function configKCFinder()
	{
		...
		$_SESSION['KCFINDER']['uploadURL'] = $_SESSION['MyApp']['docroot'].'/'.$target;
		$_SESSION['KCFINDER']['uploadDir'] = "..".$_SESSION['MyApp']['docroot'].'/'.$target;
		...
		if(!empty($_SESSION['MyApp']['hostSize']) and $_SESSION['MyApp']['hostSize']>0)
		{
			...
			$path= "..".$_SESSION['MyApp']['docroot'].'/'.$target; 
